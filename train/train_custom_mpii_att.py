...
class PoseResNet(nn.Module):
    def __init__(self, block, layers, cfg, att_type=None, **kwargs):
        self.inplanes = 64
...
def get_pose_net(is_train, **kwargs):   
    ...
    model = PoseResNet(block_class, layers, cfg, att_type, **kwargs)

    if is_train and True:
        model.init_weights('D:/MIPNet-main/models/pytorch/pose_mpii/pose_resnet_152_256x256.pth')
...
def main():   
    ...
    #########################test set###########################    
    checkpoint = torch.load("D:/MIPNet-main/output/2022-07-14_13_0/checkpoint.pth")
