...
def main():   
    ...
    for epoch in range(0, END_EPOCH):
        ...
        #perf_indicator = 0.0
        perf_indicator = validate(cfg, valid_loader, valid_dataset, model, criterion, final_output_dir, epoch, 'valid')
    ...
    validate(cfg, test_loader, test_dataset, model, criterion, final_output_dir, epoch, 'valid')
